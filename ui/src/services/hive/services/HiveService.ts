...
const NO_HIVE_KEYCHAIN_EXTENSION_ERROR_MESSAGE =
  "Hive Keychain extension is not installed, or not available to this page.";
...
export class HiveService {
  ...
  public static requestCustomJson(
    id: string,
    key: Key,
    payload: any,
    message: string
  ): Promise<CustomJsonSuccessResult | CustomJsonErrorResult> {
  ...
  public static approveValidator(
    payload: ApproveValidatorPayload,
    msg?: string
  ): Promise<CustomJsonSuccessResult | CustomJsonErrorResult> {
  ...
  public static disapproveValidator(
    payload: DisapproveValidatorPayload,
    msg?: string
  ): Promise<CustomJsonSuccessResult | CustomJsonErrorResult> {
    const display_msg =
      msg ?? `Disapprove ${payload.account_name} as validator`;
    ...
    return new Promise((resolve, reject) => {
      ...
      window.hive_keychain.requestCustomJson(
        null,
        `${Hive.PREFIX}unapprove_validator`,
        "Active",
        JSON.stringify(payload),
        display_msg,
        result => {
  ...
  public static registerAsValidator(
