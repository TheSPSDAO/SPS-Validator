...
--
-- Name: non_fungible_token_locks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.non_fungible_token_locks (
...
--
-- Name: non_fungible_tokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.non_fungible_tokens (
    id character varying(128) NOT NULL,
...
--
-- Name: non_fungible_token_locks non_fungible_token_locks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.non_fungible_token_locks
    ADD CONSTRAINT non_fungible_token_locks_pkey PRIMARY KEY (id);


--
-- Name: non_fungible_tokens non_fungible_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.non_fungible_tokens
    ADD CONSTRAINT non_fungible_tokens_pkey PRIMARY KEY (id);
...
--
-- Name: non_fungible_token_locks non_fungible_token_locks_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.non_fungible_token_locks
    ADD CONSTRAINT non_fungible_token_locks_id_fkey FOREIGN KEY (id) REFERENCES public.non_fungible_tokens(id);
