...
test.dbOnly('Garbage data for cancel_promise does not crash.', () => {
    return expect(fixture.opsHelper.processOp('cancel_promise', promise_creator, garbage_payload)).resolves.toBeUndefined();
});

test.dbOnly('Lots of emoji for cancel_promise does not crash.', () => {
    return expect(fixture.opsHelper.processOp('cancel_promise', promise_creator, emoji_payload)).resolves.toBeUndefined();
});

test.dbOnly('cancel_promise with invalid payload fails.', async () => {
    await expect(
        fixture.opsHelper.processOp('cancel_promise', promise_creator, {
            type: 'delegation',
...
test.dbOnly('cancel_promise with invalid type fails.', async () => {
    await expect(
        fixture.opsHelper.processOp('cancel_promise', promise_creator, {
            id: open_promise_id,
            type: 'invalid_type',
...
test.dbOnly('cancel_promise with non-controller account fails.', async () => {
    await expect(
        fixture.opsHelper.processOp('cancel_promise', delegator, {
            id: open_promise_id,
            type: 'delegation',
        }),
    ).resolves.toBeUndefined();
...
test.dbOnly('cancel_promise on open promise succeeds.', async () => {
    await expect(
        fixture.opsHelper.processOp('cancel_promise', promise_creator, {
            id: open_promise_id,
            type: 'delegation',
...
test.dbOnly('cancel_promise on cancelled promise fails.', async () => {
    await expect(
        fixture.opsHelper.processOp('cancel_promise', promise_creator, {
...
test.dbOnly('cancel_promise on fulfilled promise succeeds and reverses.', async () => {
    await expect(
        fixture.opsHelper.processOp('cancel_promise', promise_creator, {
