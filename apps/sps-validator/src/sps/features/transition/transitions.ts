...
export const TransitionPointDescriptions = {
    ...
    delegation_offer_controller_creation:
        'Transition point for enabling controller-based delegation offer creation (allowing a controller to create offers on behalf of a lender) and auto-generated promise IDs for delegation_offer type.',
} as const;
