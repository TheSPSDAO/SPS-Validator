import * as presale from './license_tranches/presale.json';
import * as tranche1 from './license_tranches/tranche_1.json';
import * as tranche2 from './license_tranches/tranche_2.json';
import * as tranche3 from './license_tranches/tranche_3.json';
import * as tranche4 from './license_tranches/tranche_4.json';
import * as tranche5 from './license_tranches/tranche_5.json';
import * as tranche6 from './license_tranches/tranche_6.json';
import * as tranche7 from './license_tranches/tranche_7.json';
import * as niceSale from './bonus.json';
