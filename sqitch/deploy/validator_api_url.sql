-- Deploy splinterlands-validator:validator_api_url to pg

BEGIN;

ALTER TABLE :APP_SCHEMA.validators
    ADD COLUMN api_url TEXT DEFAULT NULL,
    ADD COLUMN last_version TEXT DEFAULT NULL;

ALTER TABLE snapshot.validators
    ADD COLUMN api_url TEXT DEFAULT NULL,
    ADD COLUMN last_version TEXT DEFAULT NULL;
