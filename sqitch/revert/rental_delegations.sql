...
-- Restore post_snapshot_restore to version from token_transfer_keys
...
-- Restore freshsnapshot to version from consecutive_missed_blocks
...
-- Restore slimifysnapshot to version from consecutive_missed_blocks
